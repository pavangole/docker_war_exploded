...
<head>
    ...
    <link rel="stylesheet" href="https://digitdeveloper.online/websites/cms/cms/assets/css/admin_dashboard.css">
    <link rel="stylesheet" href="https://digitdeveloper.online/websites/cms/cms/assets/css/admin_dashboard_table.css"
    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="server.jsp" class="nav-link  active text-white ">
                        <svg class="bi me-2" width="16" height="16">
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                   id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkRUKRJvv-AznH1erobEqUZ0zrLdP8bzGFe5BSNJ5E2KQWS6Ga9-ZCIuS0wHNOIG4b758&usqp=CAU" alt="" width="32" height="32" class="rounded-circle me-2">
                    <strong></strong>
                </a>
                        ...
                        <div class="col-md-14">
                            <div class="table-wrap" style="align-content: flex-end;">
                                ...
                                <table class="table" style="margin-top: 20px">
                                    ...
                                    <% while (set.next()) {
                                        out.println("<tr>");
                                        out.println("<td>" + set.getString(1) + " ");
                                        out.println("<td>" + set.getString(2) + " ");
