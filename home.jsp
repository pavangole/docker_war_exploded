    ...
    <main>
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="home.jsp" class="nav-link active" aria-current="page">
                ...
                <li>
                    <a href="server.jsp" class="nav-link  text-white ">
                        <svg class="bi me-2" width="16" height="16">
                ...
                <h3 class=" text-center   ">Launch Your Server</h3>
                    ...
                    <div class="god ">
                        <div class="form-group mb-3">
                            <label for="text" class="form-label  ">Server Name</label>
                            <input type="name" class="form-control " id="text" name="name" aria-describedby="emailHelp"
                                   autocomplete="off">
                        </div>

                        <div class="form-group mb-3">
                            <label for="password" class="form-label  ">Server Username</label>
